...
public class MypageReserDetailDao {

	public static List<MypageReserDetailVo> selectList(String num, Connection conn) {
		...
		ResultSet rs = null;
		List<MypageReserDetailVo> voList = new ArrayList<MypageReserDetailVo>();
...
//				String no_1 = rs.getString("NO_1");//프로멤버의NO이랑 APPOINT의 NO이랑 칼럼명 중복되서 NO_1로 칼럼명이 자동지정된건데 이게 문제인지... ?
				...
				MypageReserDetailVo vo = new MypageReserDetailVo();
				vo.setNo(no);
