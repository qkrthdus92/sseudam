...
public class MypageCommentVo {
	...
	public MypageCommentVo(String no, String review_board_no, String free_board_no, String writer_no, String cmt,
	...
	public String toString() {
		return "MypageCommentVo [no=" + no + ", review_board_no=" + review_board_no + ", free_board_no=" + free_board_no
				+ ", writer_no=" + writer_no + ", cmt=" + cmt + ", cmt_date=" + cmt_date + ", delete_yn=" + delete_yn
				+ ", modify_date=" + modify_date + ", type=" + type + "]";
	}
