...
@WebServlet(urlPatterns = "/admin/nyam/delete")
@MultipartConfig(
        fileSizeThreshold = 1024 * 1024,
        maxFileSize = 1024 * 1024 * 50,
        maxRequestSize = 1024  *1024 * 50 * 5
    )
public class AdminNyamdeleteController extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String path = rootPath +"resources/upload/nyam/";
       
        //기존 파일 삭제
        new File(path+imgPath).delete();
        
        //디비 다녀오기
        int result = new AdminHealingService().DeleteNyamOne(no);
