...
@WebServlet(urlPatterns = "/admin/freeBoard/writeCmt")
public class AdminFreeBoardWriteCmtController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//디비에 관리자 댓글 인서트
		int result = new AdminFreeBoardService().insertFreeBoardCmt(bno, cmt);
