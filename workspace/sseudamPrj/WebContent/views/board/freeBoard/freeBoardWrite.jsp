...
<style>
    ...
    <div id="wrap">
        ...
        <div id="main">
            ...
            <div id="write-box">
                <div id="write-title">제목<br><input type="text" size="130" style="height:25px"></div>
                <div id="write-content">내용<br><textarea name="content" cols="132%" rows="30" style="resize:none;" required></textarea></div>
                <div id="btn">
