...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
 <%
  MypageLikeVo vo = (MypageLikeVo)request.getAttribute("vo");
%>  
		 ...
		 <%}%> --%>
		  ...
		  <div class="content">
				...
				<div class="popup-foot">
					<!-- 삭제페이지로 이동 -->
					<button class="pop-btn" id="confirm" onclick="location.href='/sseudam/mypage/likeyumdelete?no=<%=vo.getNo() %>'" >삭제</button> 
					<button class="pop-btn" id="close" onclick="location.href='/sseudam/mypage/likeyum?pno=1'" >창 닫기</button>
				</div>
		  </div>
		</div>
