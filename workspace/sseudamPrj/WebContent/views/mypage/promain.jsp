    ...
    <div id="main">
        ...
        <div id="right4">
            <table>
                ...
                <tr>
                    <th id="rightbot1"><img  id ="icon" src="../../resources/img/mypage/수익.png" alt="결제2">&nbsp;&nbsp;수익조회 <button id="editbnt" onclick="location.href='/sseudamPrj/views/mypage/proresercheck.jsp';">조회</button></th>
                    <td></td>
                </tr>
            </table>
        </div>
