...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="<%=root1%>/resources/css/admin/yamyam/cafe/list.css?ver=1"
    />
  </head>
  <body>
        ...
        <div class="admin-main-section-top">
          ...
          <div class="add-btn">
            <input
              type="button"
              value="혼카페 추가"
              onclick="location.href='<%=root%>/views/admin/yamyam/cafe/add.jsp'"
            />
          </div>
        </div>
        <div class="admin-main-wrapper">
          <div class="admin-main-board-top">
            ...
            <div class="main-select-btn">
              <select name="" id=""  onchange="window.open(value,'_self');">
                <option value="<%=root%>/admin/nyam?pno=1&type=2&sort=1">모든 게시글 조회</option>
                <option value="<%=root%>/admin/nyam?pno=1&type=2&sort=2">게시 완료 조회</option>
                <option value="<%=root%>/admin/nyam?pno=1&type=2&sort=3">게시 취소 조회</option>
              </select>
            </div>
          </div>
          <div class="admin-main-board">
            ...
            <div>
              <a href="<%=root%>/views/admin/yamyam/cafe/edit.jsp"
