        ...
        <div class="admin-main-wrapper">
          <div class="admin-main-board-top">
            ...
            <div class="main-select-btn">
              <select name="" id=""  onchange="window.open(value,'_self');">
                <option value="<%=root%>/admin/nyam?pno=1&type=1&sort=1">모든 게시글 조회</option>
                <option value="<%=root%>/admin/nyam?pno=1&type=1&sort=2">게시 완료 조회</option>
                <option value="<%=root%>/admin/nyam?pno=1&type=1&sort=3">게시 취소 조회</option>
              </select>
            </div>
          </div>
