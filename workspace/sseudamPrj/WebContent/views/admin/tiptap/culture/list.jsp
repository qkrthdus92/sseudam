...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="/sseudamPrj/resources/css/admin/tiptap/culture/list.css?ver=1"
    />
  </head>
  <body>
      ...
      <section class="admin-main-section">
        <div class="admin-main-section-top">
          ...
          <div class="add-btn">
            <input
              type="button"
              value="문화 추가"
              onclick="location.href='<%=root%>/views/admin/tiptap/culture/add.jsp'"
            />
          </div>
        </div>
        <div class="admin-main-wrapper">
          ...
          <div class="admin-main-board">
            ...
            <div>100</div>
            <div>
              <a href="<%=root%>/views/admin/tiptap/culture/edit.jsp"
